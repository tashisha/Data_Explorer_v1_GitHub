...
public class Bat_Dropdown : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
{
    ...
    {
        if((DropDown_Location == 0) || (DropDown_Location == 7))
        {
            this.gameObject.GetComponent<Image>().sprite = BasicStar_Hover;
            Debug.Log("circle Hover");
        }

        if((DropDown_Location == 1) || (DropDown_Location == 2) || (DropDown_Location == 3) || (DropDown_Location == 4) || (DropDown_Location == 5) || (DropDown_Location == 6) || (DropDown_Location == 8))
        {
    ...
    public void ddLocationChange(TMPro.TMP_Dropdown sender)
    {
        ...
        else if((DropDown_Location == 1) || (DropDown_Location == 2) || (DropDown_Location == 3) || (DropDown_Location == 4) || (DropDown_Location == 5) || (DropDown_Location == 6) || (DropDown_Location == 8))
        {
            this.gameObject.GetComponent<Image>().sprite = ShinyStar;
            Debug.Log("diamond");
        }
